...
<html lang="it">
    <head>
        <title> Calendario Area Sud-Est e Portuale | Green Service SpA </title>
        <meta charset = "utf-8">
...
<body onload="parti();">
    ...
    <img id="imgMappaCE" src="../img/mappaSE2.png" alt = "Area Centrale-Marittima"> 
    <h2 id="TitleCalendario"> Calendario Area Sud-Est e Portuale</h2> 
