...
<html lang="it">
    <head>
        <title> Calendario Area Nord-Ovest | Green Service SpA </title>
        <meta charset = "utf-8">
...
<body onload="parti();">
    ...
    <img id="imgMappaNW" src="../img/mappaNW2.png" alt = "Area Nord-Ovest"> 
    <h2 id="TitleCalendario"> Calendario Area Nord-Ovest</h2> 
