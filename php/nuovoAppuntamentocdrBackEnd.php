...
<html lang = "it">
    ...
    <?php
        ...
        if($provenienza !== "cancellazione")
        {
            ...
            storeDBnewRecordCDRActual($rifiuto, $quantita);
        }
        ...
        else
        {
            ...
            while($rows = $result->fetch_assoc()){
                ...
                $riga2 = 
                "
                <td> <a class=\"button\" href=\"./process/cancellaCDRProcess.php?descrizione=$descrizione\"> CANCELLA </a> </td>
                </tr>";
            ...
            echo "<br>";
            echo "<a class=\"button\" href=\"nuovoAppuntamentocdrBackEnd2.php\"> PROSEGUI </a>";
            echo "</div>";
            echo "<br>";
        }
    ?>
